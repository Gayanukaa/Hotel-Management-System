...
class RoomDetails:
    ...
    def showPage(self, n):
        ...
        if(self.currentPage == 1):
            ...
            singleRoom = PhotoImage(file="Images/Single_Room_1.png",height=200,width=200)
            Label(frame1, image=singleRoom).place(x=0,y=50)
            
            doubleRoom = PhotoImage(file="Images/Double_Room_1.png")
            ...
            tripleRoom = PhotoImage(file="Images/Triple_Room_1.png",height=200,width=200)
            Label(frame2, image=tripleRoom).place(x=0,y=50)
            
            quadRoom = PhotoImage(file="Images/Quad_Room_1.png")
            ...
            queenRoom = PhotoImage(file="Images/Queen_Room_1.png",height=200,width=200)
            Label(frame3, image=queenRoom).place(x=0,y=50)
            
            kingRoom = PhotoImage(file="Images/King_Room_1.png")
            ...
            suiteRoom = PhotoImage(file="Images/Suite_Room_1.png",height=200,width=200)
            Label(frame4, image=suiteRoom).place(x=0,y=50)
            
            twinRoom = PhotoImage(file="Images/Twin_Room_1.png")
